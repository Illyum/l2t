...
namespace IllyumL2T.Core.FieldsSplit.Parse
{
  ...
  {
    public IEnumerable<ParseResult<T>> Read(TextReader reader, bool includeHeaders, bool skipEmptyLines = true)
    {
      var fieldsSplitter = new FixedWidthValuesFieldsSplitter<T>();
